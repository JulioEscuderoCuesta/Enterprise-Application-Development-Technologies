...
public class AppFeeder implements CommandLineRunner {
	...
	private void feedDatabase() {
		...
		Season season11 = new Season(1, series1);
		Season season12 = new Season(2, series1);
		//Season season12 = new Season(2, series1);
		Chapter chapter111 = new Chapter("Se acerca el invierno", "Los Starks de Invernalia acogen la visita de la familia real, del rey Robert Baratheon. Paralelamente, al otro lado del mar, el príncipe" + 
		"exiliado Targaryen traza una alianza para recuperar el Trono de Hierro.", 1, Duration.ofMinutes(54).plusSeconds(27), "link1", LocalDate.of(2011, 4,17), season11);
		Chapter chapter112 = new Chapter("El camino real", "Ned parte hacia Desembarco del Rey, tras aceptar la oferta como Mano del Rey, acompañado de sus hijas Sansa y Arya. También le acompaña Jon Nieve," +
		"su hijo bastardo, quien se dirige al Muro para unirse a la Guardia de la Noche.", 2, Duration.ofMinutes(50).plusSeconds(45), "link2", LocalDate.of(2011, 4,24), season11);
		Chapter chapter121 = new Chapter("El norte recuerda", "En los siete reinos se bate una furiosa guerra civil, Stannis Baratheon y Renly no reconocen a Jeoffrey como rey y ambos aspiran al Trono de Hierro." + 
		"Mientras, el Norte se ha declarado independiente y Tyrion es nombrado Mano del Rey.", 1, Duration.ofMinutes(55).plusSeconds(55), "link3", LocalDate.of(2012, 4,1), season12);
		
		chaptersSeason1Series1.add(chapter111);
		chaptersSeason1Series1.add(chapter112);
		chaptersSeason2Series1.add(chapter121);
		season11.setChapters(chaptersSeason1Series1);
		season12.setChapters(chaptersSeason2Series1);
		seasonsSeries1.add(season11);
		seasonsSeries1.add(season12);
		...
		//Season season12 = new Season(2, series1);
		Chapter chapter1Series1Series2 = new Chapter("Piloto", "A Walter White, profesor de química de instituto, le diagnostican un cáncer de pulmón en fase terminal. El hombre se obsesiona con "+
		...
		chaptersSeason1Series2.add(chapter1Series1Series2);
		...
		//Season season12 = new Season(2, series1);
		Chapter chapter1Series1Series3 = new Chapter("Días pasados", "Rick Grimes, policía de una pequeña localidad de Georgia, despierta de un coma y repentinamente se encuentra en un mundo apocalíptico. Desorientado," +
		...
		chaptersSeason1Series3.add(chapter1Series1Series3);
